...
const harryPotterTrigger = document.getElementById('1');
const lordOfTheRingsTrigger = document.getElementById('2');
const bookContent = document.getElementById('sammy-app');
